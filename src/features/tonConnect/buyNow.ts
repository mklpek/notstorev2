 ...
 */
export const createBuyNowTransaction = (product: Item, quantity: number = 1): SendTransactionRequest => {
 ...
 * @returns TON Connect transaction request
 */
export const createCartTransaction = (cartItems: CartItem[], totalAmount: number): SendTransactionRequest => {
