...
const CartModal: React.FC<CartModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} isEmpty={isEmpty}>
      <div className={`${styles.cartModal} ${isEmpty ? styles.emptyCartModal : styles.filledCartModal}`}>
        ...
        <button 
          ...
          style={isEmpty ? { position: 'absolute', top: '16px', right: '16px', zIndex: 10 } : { /* Dolu sepet için stiller CSS'den gelecek */ }}
        >
              ...
              {expandedCartItems.map(item => {
                return (
                  <div key={item.uniqueKey} className={styles.basketLine}>
                    ...
                    >
                      <svg className={styles.removeIcon} width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <path d="M1.25 8H14.75" stroke="#B8CADF" strokeWidth="1.5" strokeLinecap="round"/>
                      </svg>
                    </button>
                  </div>
                );
        ...
        <div className={styles.cartFooter}>
          <button 
            ...
            onClick={isEmpty ? onClose : handlePurchase}
          >
