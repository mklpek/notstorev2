...
import { useGetHistoryQuery, useGetEmptyHistoryQuery, selectVisibleHistoryItems, selectRemainingHistoryCount } from './api'
...
const AccountPage: React.FC = () => {
  ...
  useEffect(() => {
    if (standardHistoryResult.error && !useEmptyHistoryAPI) {
      console.log('History API hatası, boş history API\'sine geçiliyor', standardHistoryResult.error);
  ...
  const getProductInfo = useCallback((productId: number) => {
                ...
                <div key={uniqueKey} className={styles.historyLine}>
                  ...
                  <div className={styles.historyInfo}>
                    ...
                    <div className={styles.purchaseInfo}>
                      <span className={styles.purchaseDate}>{dateFormatter.format(purchase.timestamp)}</span>
                      <div className={styles.priceContainer}>
                        <span className={styles.price}>{purchase.total} {purchase.currency}</span>
                      </div>
                    </div>
                  </div>
                </div>
