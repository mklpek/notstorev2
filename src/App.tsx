...
function App() {
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty('--tg-theme-hint-color', WebApp.themeParams.hint_color || 'rgba(255, 255, 255, 0.5)')
  }, [])
        ...
        <Routes>
          ...
          <Route element={
            ...
            <Route path="profile" element={
              <Suspense fallback={<AccountPageSkeleton showHistory={true} historyItemCount={6} />}>
                <AccountPage />
              </Suspense>
            } />
          </Route>
